...
window.addEventListener('error', (event) => {
    ...
    if (event.message && (event.message.includes('Frame with ID') ||
...
window.addEventListener('unhandledrejection', (event) => {
    ...
    if (event.reason && event.reason.message && (event.reason.message.includes('Frame with ID') ||
