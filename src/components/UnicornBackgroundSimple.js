...
const UnicornBackgroundSimple = ({ children, className = '' }) => {
    ...
    useEffect(() => {
        if (isBlackBackgroundPage) {
            ...
            if (unicornContainer) {
                ...
                unicornContainer.style.opacity = '0.8';
            }
        ...
        if (!isBlackBackgroundPage) {
            ...
            const ensureVisibility = () => {
                ...
                if (unicornContainer) {
                    unicornContainer.style.display = 'block';
                    unicornContainer.style.opacity = '0.8';
                    unicornContainer.style.visibility = 'visible';
                }
            };
            // Immediate attempt
            ensureVisibility();
    ...
    return (_jsxs("div", { className: `relative min-h-screen ${className}`, children: [_jsx("div", { className: `fixed inset-0 w-full h-full pointer-events-none background-transition ${isBlackBackgroundPage ? 'record-page' : 'non-record-page'}`, style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    right: 0,
                ...
                } })), _jsx("div", { className: "relative z-10", children: children }), _jsx("style", { children: `
